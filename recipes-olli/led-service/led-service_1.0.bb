...
SRCREV = "1e60b6989156a3c04e0b178ffb802ee7038945a5"
SRC_URI = " \
...
do_install_append () {
	...
	install -m 0755 ${WORKDIR}/git/led_clear	 ${D}/home/root/led-service
	install -m 0755 ${WORKDIR}/git/led_fade	 ${D}/home/root/led-service
	install -m 0755 ${WORKDIR}/git/led_rainbow	 ${D}/home/root/led-service
	install -m 0755 ${WORKDIR}/git/led_volume	 ${D}/home/root/led-service
	install -m 0755 ${WORKDIR}/git/led_wakeup	 ${D}/home/root/led-service
